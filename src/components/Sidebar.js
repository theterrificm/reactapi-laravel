        ...
        <div className="sem bg-white mb-3">
                    ...
                    <div className='bg-white filter-height filter mb-3 ps-2 py-3'>
                        <div class="form-group form-check">
                            ...
                            <input type="radio" className="form-check-input" name="macbook"  id="macbook" /> 
                        ...
                        <div class="form-group form-check">
                            ...
                            <label className="form-check-label" for="macbook">Macbook Pro</label>
                        </div>
                        <div class="form-group form-check">

                            <input type="radio" className="form-check-input" name="macbook"  id="macbook" /> 

                            <label className="form-check-label" for="macbook">Macbook Air</label>
                        </div>
                    </div>
